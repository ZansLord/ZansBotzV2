...
const start = async(sesion) => {
    ...
    console.log(color(figlet.textSync('Zans-Bot', {
		font: 'Standard',
		horizontalLayout: 'default',
		vertivalLayout: 'default',
		whitespaceBreak: false
	}), 'cyan'))
	console.log(color('[ CREATED BY ZANSLORD ]'))

    xinz.on('qr', qr => {
        qrcode.generate(qr, { small: true })
        console.log(XinzLog('Scan QR Kont gak Scan Gak connect ~~'))
    })
    ...
    xinz.on('open', (json) => {
		console.log(XinzLog('Connect, Welcome Mamank'))
	})
